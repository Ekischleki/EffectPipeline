...
namespace EffectPipeline.effects
{
    internal class WhiteNoise : IEffect
    {
        ...
        public IEnumerable<(string, Type)> Outputs => [("Noise", Type.GreyscaleImage)];
        ...
        {
            var seed = ((NumberInputProperty)properties[0]).Value;
            var width = ((NumberInputProperty)properties[1]).Value;
            var height = ((NumberInputProperty)properties[2]).Value;
            var bound_1 = ((FloatInputProperty)properties[3]).Value;
            var bound_2 = ((FloatInputProperty)properties[4]).Value;
